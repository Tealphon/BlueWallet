module.exports = {
  ...
  wallets: {
    select_wallet: '選擇錢包',
    options: '選項',
    createBitcoinWallet: '您當前沒有比特幣錢包. 為了支援閃電錢包, 需要建立或者匯入一個比特幣錢包. 是否需要繼續?',
    list: {
      app_name: 'BlueWallet',
      title: '錢包',
      header: '一個錢包代表一對的私鑰和地址' + '你可以通過分享收款.',
      add: '新增錢包',
      create_a_wallet: '變出一個新錢包',
      create_a_wallet1: '變出錢包是免費的',
      create_a_wallet2: '想變出多少個就變出多少個',
      latest_transaction: '最近的轉帳',
      empty_txs1: '你的轉帳資訊將展示在這裡',
      empty_txs2: '當前無資訊',
  ...
  settings: {
    ...
    lightning_settings_explain: '如要要連線你自己的閃電節點請安裝LndHub' + ' 並把網址輸入到下面. 空白將使用預設的LndHub (lndhub.io)',
    electrum_settings: 'Electrum 設定',
    electrum_settings_explain: 'Set to blank to use default',
    save: '儲存',
    about: 'BlueWallet相關資訊',
    language: '語言',
    currency: '貨幣',
    advanced_options: '進階設定',
    enable_advanced_mode: '開啟進階設定',
  },
  ...
  lnd: {
    ...
    expired: '超時',
    placeholder: 'Invoice',
    sameWalletAsInvoiceError: '你不能用建立帳單的錢包去支付該帳單',
  },
  pleasebackup: {
